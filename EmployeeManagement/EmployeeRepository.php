...
{
    public function insertEmployee(?mysqli $conn, Employee $employee): bool
    {
        if ($conn === null) {
            return false;
        }
    ...
    public function viewAllEmployee(?mysqli $conn, Employee $employee)
    {
        if ($conn == null) {
            return false;
        }
    ...
    public function viewEmployeeById(?mysqli $conn, int $id): bool
    {
        if ($conn === null) {
    ...
    public function updateEmployee(?mysqli $conn, Employee $employee): bool
    {
        if ($conn === null) {
            return false;
        }
